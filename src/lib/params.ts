...
export const HOME: HomePageParams = {
	...
	lastName: 'K. Baghi',
	description:
		`Experienced full-stack developer with expertise in scalable web apps, specializing in ReactJs, Svelte, and Node.js with keen interest in DevOps engineering. 
